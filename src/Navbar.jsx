...
function Navbar() {
    return (
        <nav className="bg-blue-800 text-white p-4 flex justify-between items-center fixed top-0 left-0 right-0 w-full h-16 shadow-md z-50">
            {/* Smaller EduMap in Navbar*/}
            <h1 className="text-2xl font-bold">EduMap</h1>

            {/* White text inside of the links*/}
