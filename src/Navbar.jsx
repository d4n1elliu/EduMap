...
function Navbar() {
    ...
    return (
        ...
        {/* Navbar Background Styling */}
            ...
            {/* Navigation bar appears once user logs in/signs up*/}
            {token ? (
                <ul className="flex items-center space-x-8 text-white font-medium">
                    <li>
                        <NavLink to="/course-questionnaire" className={({ isActive }) => isActive ? "text-blue-700" : "hover:text-blue-200"}>Course Questionnaire</NavLink>
                    </li>
                    <li>
                        <NavLink to="/job-prospects" className={({ isActive }) => isActive ? "text-blue-700" : "hover:text-blue-200"}>Job Prospects</NavLink>
                    </li>
                    <li>
                        <NavLink to="/buddy-system" className={({ isActive }) => isActive ? "text-blue-700" : "hover:text-blue-200"}>Buddy System</NavLink>
                    </li>
                    <li>
                        <NavLink to="/about" className={({ isActive }) => isActive ? "text-blue-700" : "hover:text-blue-200"}>About Us</NavLink>
                    </li>
                    <li>
